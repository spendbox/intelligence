  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-600">Payments, pricing and the credit economy.</p>
      </div>
      ...
      <form action={saveSettingsAction} className="space-y-6 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div className="flex items-start justify-between gap-4 rounded-lg border border-slate-200 bg-slate-50 p-4">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-600">When off, users see a "Coming soon" placeholder.</p>
          </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            ...
            <div className="mt-1 flex rounded-lg border border-slate-300 focus-within:border-brand focus-within:ring-2 focus-within:ring-brand/20">
              ...
              <input type="number" name="price_monthly" step="0.01" min="0" required defaultValue={monthly} inputMode="decimal" className="w-full rounded-r-lg px-3 py-2 outline-none" />
            </div>
          </div>
          <div>
            <label className="text-sm font-medium">Yearly subscription</label>
            <div className="mt-1 flex rounded-lg border border-slate-300 focus-within:border-brand focus-within:ring-2 focus-within:ring-brand/20">
              <span className="flex items-center px-3 text-slate-500">{symbol}</span>
              <input type="number" name="price_yearly" step="0.01" min="0" required defaultValue={yearly} inputMode="decimal" className="w-full rounded-r-lg px-3 py-2 outline-none" />
            </div>
          </div>
        </div>
        ...
        <div className="rounded-lg border border-brand/20 bg-brand/5 p-4">
          ...
          <p className="mt-1 text-xs text-slate-600">Controls how naira converts to credits and how much it costs to unlock leads.</p>
